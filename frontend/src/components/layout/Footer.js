            ...
            <div className="row">
              <div className="col-lg-5 col-md-6 col-12">
                ...
                <div className="single-footer about">
                  <div className="logo">
                    <a href="index.html"><img style={{width:70, height:70}} src="/images/logo.png"  alt="#" /></a>
                  </div>
                  <p className="text">Website bán hàng trực tuyến của Nhóm 1, hỗ trợ 24/7 cùng nhiều ưu đẫi hấp dẫn. Luôn luôn cập nhật mới nhiều sản phẩm.</p>
              ...
              <div className="col-lg-3 col-md-6 col-12">
                ...
                <div className="single-footer social">
                  ...
                  <div className="contact">
                    <ul>
                      <li>Trường Cao Đẳng Bách Khoa</li>
                      <li>Nhóm 3</li>
              ...
              <div className="row">
                <div className="col-lg-12 col-12">
                  <div className="text-center">
                    <p>Copyright © 2024 By Nhóm 1. All rights reserved.</p>
                  </div>
                </div>
